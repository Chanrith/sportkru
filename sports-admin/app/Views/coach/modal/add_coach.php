...
<div class="row mt-2">
    ...
    <div class="form-group col-6">
     ...
     <div class="form-group col-6">
         ...
         <input type="text" class="form-control" id="mobile_number" placeholder="Mobile Number" name="mobile_number"  maxlenght="20" minlength="10" >
     </div>
     <div class="form-group col-6">
         <label class="" for="alternative_number">Alternative Number *</label>
         <input type="text" class="form-control" id="alternative_number" placeholder="Alternative Number" name="alternative_number"  maxlenght="20" minlength="10" >
     </div>
     <div class="form-group col-6">
     ...
     <div class="form-group col-6">
         ...
         <div class="form-group col-6">
             ...
             <label class="row  justify-content-center mx-0 floating-label" style="height: 60px;width:50%;border: 1px solid #ced4da;border-radius:4px;background:#fff;top: 23px;left: 4px;" for="image">
                ...
                <img id="imageImage" onerror="this.src='<?=base_url()?>/assets/images/default-img.png';" src="<?=base_url()?>/assets/images/default-img.png"  style="max-width:100%;max-height:100%;">
            </label>
         </div>
</div>
</form>
    ...
    <div class="modal-footer">
        ...
        <button id="submit" form="addCoach" class="btn btn-success">Save</button>
    </div>
