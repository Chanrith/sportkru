...
<form class="row g-3 " id="formData">
	<div class="modal-body mt-0">
		<div class="form-check mb-3 input-group form-group  p-0">
			...
			<input class="form-control" id="addRoleName" placeholder="" name="role_name" aria-describedby="addRoleNameGroup" autocomplete="off">
		</div>
		<div class="accordion custom-roleCollapse accordion-secondary userRoleAccordion" id="roleCollapse">
			<?php $sno=1;foreach($modules as $row){?>
				...
				<h2 class="accordion-header" id="roleSelectcollapse5">
					<button class="accordion-button collapsed" type="button"  data-bs-target="#accor_<?=$sno?>" aria-expanded="false" aria-controls="accor_<?=$sno?>">
						<div class="form-check ">
							<input class="form-check-input roleAll" type="checkbox" id="role_<?=$sno?>">
				...
				<div id="accor_<?=$sno?>" class="accordion-collapse collapse show userRoleAccordionCollapse" aria-labelledby="roleSelectcollapse5" data-bs-parent="#role_<?=$sno?>">
					<div class="accordion-body">
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="form-check ">
									<input class="form-check-input" type="checkbox" id="viewUsers_<?=$sno?>" name="item[<?=$sno?>][allow_view]" value="1">
							...
							<div class="col-sm-3">
								<div class="form-check ">
									<input class="form-check-input" type="checkbox" id="createUsers_<?=$sno?>" name="item[<?=$sno?>][allow_create]" value="1">
							...
							<div class="col-sm-3">
								<div class="form-check ">
									<input class="form-check-input" type="checkbox" id="editUsers_<?=$sno?>" name="item[<?=$sno?>][allow_edit]" value="1">
							...
							<div class="col-sm-3">
								<div class="form-check ">
									<input class="form-check-input" type="checkbox" id="deleteUsers_<?=$sno?>" name="item[<?=$sno?>][allow_delete]" value="1">
